describe "Nested Structures" do
  ...
  it 'adds a student to the school student array' do
    # write your code here!
    school[:students].push({:name=>"Missy", :grade=>"A"})
  ...
  it "returns the name of the student with a 'B'" do
    expect(school[:students].find {|student| student[:grade] == "B"}[:name]).to eq("Marissa")
  end

  it "returns the subject of the instructor 'Jeff'" do
    expect(school[:instructors].find {|instructor| instructor[:name] == "Jeff"}[:subject]).to eq("karaoke")
  end
end
